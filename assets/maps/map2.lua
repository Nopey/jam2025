  ...
  layers = {
    {
      ...
      encoding = "base64",
      compression = "zlib",
      data = "eJxTYGBgUKAQiwAxGxk0TD85ekVG7R+1f9R+ijEAEPURdQ=="
    },
    {
      type = "tilelayer",
      x = 0,
      ...
      encoding = "base64",
      compression = "zlib",
      data = "eJzrYGBgqALiaiCeCGVXQdkT0djoatqAeBoDBExlIAzQ1bQj6ScHTIOaQS6g1P52KthPiX6Q2ycxQOKBXPtroWaA4rWLDP0DGf6UxH8rEHdSaP9Ap19Y/MPyKDKNTQw9T08BYgBtUyQI"
    },
    {
      type = "objectgroup",
      draworder = "topdown",
